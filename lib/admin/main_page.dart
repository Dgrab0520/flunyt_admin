...
import '../admin/data/customer_data.dart';
                                                                  ...
                                                                  Row(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      InkWell(
                                                                        onTap:
                                                                            () {
                                                                          Customer_Data.deleteCus(detail[index].cus_id)
                                                                              .then((value) {
                                                                            if (value) {
                                                                              setState(() {
