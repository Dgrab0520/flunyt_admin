...
class BigPartner extends StatelessWidget {
  BigPartner({Key? key}) : super(key: key);
                    ...
                    itemBuilder: (_, int index) {
                      return PartnerRow(
                          client: partnerPageController.isSearch
                              ? partnerPageController.searchedPartners[index]
